...
# Disable torch inductor compilation — spawns 32 workers with ~10GB vmem each,
# which can exceed container virtual memory limits. Not needed for weight merging.
