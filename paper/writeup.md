...
**Alexander Rider** — Solo submission for the MedGemma Impact Challenge.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/abicyclerider/clinfuse/main/paper/figures/figure1_architecture.png" width="100%" alt="Figure 1: ClinFuse three-tier architecture">
</p>
...
<table>
  <tr style="border-bottom:2px solid #888">
    <th style="text-align:left;padding:2px 10px">Metric</th>
    <th style="text-align:right;padding:2px 10px">Demographics Only</th>
    <th style="text-align:right;padding:2px 10px">ClinFuse</th>
    <th style="text-align:right;padding:2px 10px">Reduction</th>
  </tr>
  <tr>
    <td style="text-align:left;padding:2px 10px">Split patients</td>
    <td style="text-align:right;padding:2px 10px">421</td>
    <td style="text-align:right;padding:2px 10px"><b>115</b></td>
    <td style="text-align:right;padding:2px 10px">↓ 73%</td>
  </tr>
  <tr>
    <td style="text-align:left;padding:2px 10px">Fragmentation rate</td>
    <td style="text-align:right;padding:2px 10px">14.4%</td>
    <td style="text-align:right;padding:2px 10px"><b>3.9%</b></td>
    <td style="text-align:right;padding:2px 10px">↓ 73%</td>
  </tr>
  <tr>
    <td style="text-align:left;padding:2px 10px">Unresolved patients</td>
    <td style="text-align:right;padding:2px 10px">47.7%</td>
    <td style="text-align:right;padding:2px 10px"><b>26.0%</b></td>
    <td style="text-align:right;padding:2px 10px">↓ 46%</td>
  </tr>
  <tr>
    <td style="text-align:left;padding:2px 10px">Pair F1</td>
    <td style="text-align:right;padding:2px 10px">0.764</td>
    <td style="text-align:right;padding:2px 10px"><b>0.916</b></td>
    <td style="text-align:right;padding:2px 10px">—</td>
  </tr>
</table>
</div>
